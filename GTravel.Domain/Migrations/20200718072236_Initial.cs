        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostCode = table.Column<int>(maxLength: 8, nullable: false),
                    Name = table.Column<string>(nullable: false),
                    State = table.Column<string>(maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(nullable: false),
                    TourDurationDays = table.Column<int>(nullable: false),
                    ...
                    AccommodationNumberOfNights = table.Column<int>(nullable: false),
                    RRP = table.Column<decimal>(type: "decimal(7,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TourCityId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TourAttractions_TourCities_TourCityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TourAttractions_TourCityId",
                table: "TourAttractions",
                column: "TourCityId");

            migrationBuilder.CreateIndex(
                name: "IX_TourAttractions_AttractionId_TourCityId",
                table: "TourAttractions",
                columns: new[] { "AttractionId", "TourCityId" },
                unique: true);
